...
public class ConfigManager {
    ...
    /**
     * Reload configuration at runtime (useful for tests) — re-applies the same
     * overlay order.
     * Note: this reads system properties, environment variables and the project
     * .env.config
     */
    ...
    private static void load(Properties target, String env) {
        ...
        System.getProperties().forEach((k, v) -> {
            if (k instanceof String && v != null)
                target.setProperty((String) k, v.toString());
        });
    }
    ...
    public static String getBaseUrl() {
        ...
        String alias = firstNonEmpty(props.getProperty("BASE_URL"), props.getProperty("BASEURL"),
    ...
    public static String getEnv() {
        return props.getProperty("env", props.getProperty("ENV", "dev"));
    }

    public static String getUsername() {
        return props.getProperty("USERNAME", props.getProperty("username"));
    }

    public static String getPassword() {
        return props.getProperty("PASSWORD", props.getProperty("password"));
    }

    public static long getTimeout() {
        String val = firstNonEmpty(props.getProperty("TIMEOUT"), props.getProperty("timeout"));
        if (val != null) {
            try {
