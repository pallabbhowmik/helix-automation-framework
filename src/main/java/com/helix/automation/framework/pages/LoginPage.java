...
public class LoginPage extends BasePage {
    ...
    public boolean isWelcomeBackVisible() { return isVisible(heading) && getText(heading).toLowerCase().contains("welcome back"); }
    public void enterEmail(String emailStr) { type(email, emailStr); }
